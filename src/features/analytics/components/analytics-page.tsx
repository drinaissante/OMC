    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <Select value={String(days)} onValueChange={(v) => { if (v) setDays(Number(v)) }}>
          <SelectTrigger className="w-35"><SelectValue>
            {(value) => {
              const labels: Record<string, string> = { "7": "Last 7 days", "30": "Last 30 days", "90": "Last 90 days" }
              return labels[String(value)] ?? "Last 7 days"
            }}
